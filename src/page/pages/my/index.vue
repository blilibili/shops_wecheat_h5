<template>
    <div style="height: 100vh;overflow: auto;" class="my-page">
      <div>
<!--        <van-nav-bar-->
<!--          title="我的"-->
<!--        />-->
    ...
    export default {
        ...
        data(){
          return {
            ...
            name_en:'',
            myAva:'http://94.191.74.232/uploads/img/user/20190412/d942e76b9ee2e2782a377c7c502341cb.jpg',
            sex:0,
            years:25,
            phone:'13580396632',
            email:'',
...
.my-page{
  ...
  .menu-box{
    ...
    font-size: 13px;
    .collection , .history , .red-packet ,.cart{
      text-align: center;
      .number{
        font-weight: bold;
      }
