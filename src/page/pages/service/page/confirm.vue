...
<!--      </div>-->
      ...
      <van-submit-bar
        :price="productInfo.price * productInfo.amount * 100"
        button-text="提交订单"
        @submit="createOrder"
      />
    </div>
    ...
    export default {
        ...
        data(){
          return {
            productId:'',
            productInfo:{
              logo:'https://img.alicdn.com/imgextra/https://img.alicdn.com/imgextra/i4/3166931255/O1CN01hr1n3v1L8paZVgC8R_!!3166931255.jpg_430x430q90.jpg',
              seller:'阿里大药房',
              productImg:'https://img.alicdn.com/imgextra/https://img.alicdn.com/imgextra/i4/3166931255/O1CN01hr1n3v1L8paZVgC8R_!!3166931255.jpg_430x430q90.jpg',
              proName:'善存药片',
              price: 19.9,
              desc:'为您的健康做保障',
              amount:2
